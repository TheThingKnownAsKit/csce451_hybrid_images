...
origninal_identity_image  = imfilter(test_image, identity_filter);

figure(2); imshow(identity_image);
figure(3); imshow(origninal_identity_image);
...
original_blur_image = imfilter(test_image, blur_filter);

figure(4); imshow(blur_image);
figure(5); imshow(original_blur_image);
...
original_large_blur_image = imfilter(test_image, large_1d_blur_filter);
original_large_blur_image = imfilter(original_large_blur_image, large_1d_blur_filter'); %notice the ' operator which transposes the filter

figure(6); imshow(large_blur_image);
figure(7); imshow(original_large_blur_image);
...
original_sobel_image = imfilter(test_image, sobel_filter);
%0.5 added because the output image is centered around zero otherwise and mostly black
figure(8); imshow(sobel_image + 0.5);
figure(9); imshow(original_sobel_image + 0.5);
...
original_laplacian_image = imfilter(test_image, laplacian_filter);

%0.5 added because the output image is centered around zero otherwise and mostly black
figure(10); imshow(laplacian_image + 0.5);
figure(11); imshow(original_laplacian_image + 0.5);
...
figure(12); imshow(high_pass_image + 0.5);
